    ...
    private static void addAxis2Configuration(final Project project) {
        ...
        if(configuration.getAllDependencies().isEmpty()) {
            configuration
                ...
                dependencies.add(dependencyHandler.create('org.apache.axis2:axis2-kernel:1.7.7'))
                dependencies.add(dependencyHandler.create('org.apache.axis2:axis2-codegen:1.7.7'))
                dependencies.add(dependencyHandler.create('org.apache.axis2:axis2-adb:1.7.7'))
                dependencies.add(dependencyHandler.create('org.apache.axis2:axis2-adb-codegen:1.7.7'))
                dependencies.add(dependencyHandler.create('org.apache.axis2:axis2-jaxbri:1.7.7'))
